    ...
    <div className="container" id="home-page">
      ...
      >
        ...
        >
          ...
          >
            <h4 style={{ textIndent: '15px', color: 'pink' }}>
              {' '}
              Code Source Books was developed by Luis, Larry, Seth, and Ioan.{' '}
            </h4>
            <h4 style={{ textIndent: '15px', color: 'pink' }}>
              {' '}
              This is the nicest bookstore website you've ever seen!
            </h4>
          </div>
        </div>
        <div
        ...
        >
          <img
            ...
            src="https://images.pexels.com/photos/1029807/pexels-photo-1029807.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940"
          />
        </div>
      </div>
    </div>
